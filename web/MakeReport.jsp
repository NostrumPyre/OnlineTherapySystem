<%-- 
    Document   : MakeReport
    Created on : Jan 28, 2022, 2:51:47 AM
...
<div class="md:flex flex-col md:flex-row md:min-h-screen w-full">
  ...
  <div class="py-16 px-24  w-full  bg-indigo-300 bg-opacity-50">
    <div class="flex justify-between">
        <h1 class="text-3xl mb-10 text-indigo-600 font-semibold">Make Report</h1>
        ...
        <div class="shadow sm:rounded-md sm:overflow-hidden">
          <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            ...
            <div class="col-span-6 m-0 sm:col-span-3">
                ...
                <input type="date" name="date" id="date" autocomplete="given-name" class="p-2 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full border border-gray-300 shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            <div>
              ...
              <div class="mt-1">
                <textarea id="about" name="report" rows="3" class="p-4 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Type your patient report here . . ."></textarea>
              </div>
            </div>
