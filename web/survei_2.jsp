<%-- 
    Document   : survei_2
    Created on : Jan 26, 2022, 10:51:21 PM
    Author     : syafa
--%>
...
<html>
    ...
    <body style = "position: relative; height: 896px;">
        ...
        <center>
            <form name = "Survei_2_Form" method = "post" action = "survei_3.jsp" onsubmit = "return validateForm()">
                ...
                <div style = "position: absolute; width: 522px; height: 388px; left: 380px; top: 358px; background-color: rgba(133, 140, 228, 0.5);">
                    <h1 style = "color: white;">How old are you?</h1>
                </div>
                
                <p style = "position: absolute; width: 150px; height: 15px; left: 504px; top: 480px;
                ...
                <input style = "position: absolute; width: 261px; height: 54px; left: 515px; top: 525px; background-color: #858CE4; border: 2px solid #FFFFFF;
                                font-family: Mulish; font-style: normal; font-weight: bold; font-size: 28px; 
                                line-height: 35px; 
                                letter-spacing: 0.1px;
                                color: #FFFFFF;" 
                       type = "text" name = "age" required/> <br/> <br/>
