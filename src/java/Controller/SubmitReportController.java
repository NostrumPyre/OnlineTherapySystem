...
public class SubmitReportController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Report report_data = new Report();
        report_data.addReport(appointment_id, report, date);
        
        request.getRequestDispatcher("ConditionDetailController").forward(request, response);
    }
