<%-- 
    Document   : survei_3
    Created on : Jan 26, 2022, 10:52:29 PM
    Author     : syafa
--%>
...
<html>
    ...
    <body style = "position: relative; height: 896px;">
        ...
        <form name = "Survei_3_Form" method = "post" action = "survei_4.jsp" onsubmit = "return validateForm()">
            <center>
                ...
                <div style = "position: absolute; width: 522px; height: 518px; left: 380px; top: 358px; background-color: rgba(133, 140, 228, 0.5);">
                    <h1 style = "color: white;">How do you identify?</h1>
                </div>
            </center>
              
            <input style = "position: absolute; width: 261px; height: 54px; left: 515px; top: 481px; background-color: #858CE4; border: 2px solid #FFFFFF;
                            font-family: Mulish; font-style: normal; font-weight: bold; font-size: 28px;
                            text-align: left;
                            line-height: 35px;
                            letter-spacing: 0.1px;
                            color: #FFFFFF;" 
                   type = "submit" name = "preference" value = "Straight" /> <br/> <br/> 
            <input style = "position: absolute; width: 261px; height: 54px; left: 515px; top: 560px; background-color: #858CE4; border: 2px solid #FFFFFF;
                            ...
                            letter-spacing: 0.1px;
                            color: #FFFFFF;" 
                   type = "submit" name = "preference" value = "Guy" /> <br/> <br/>
            <input style = "position: absolute; width: 261px; height: 54px; left: 515px; top: 640px; background-color: #858CE4; border: 2px solid #FFFFFF;
                            ...
                            letter-spacing: 0.1px;
                            color: #FFFFFF;" 
                   type = "submit" name = "preference" value = "Lesbian" /> <br/> <br/>
            <input style = "position: absolute; width: 261px; height: 54px; left: 515px; top: 719px; background-color: #858CE4; border: 2px solid #FFFFFF;
                            font-family: Mulish; font-style: normal; font-weight: bold; font-size: 28px;
                            text-align: left;
                            line-height: 35px;
                            letter-spacing: 0.1px;
                            color: #FFFFFF;" 
                   type = "submit" name = "preference" value = "Other" /> <br/> <br/>
            <input style = "position: absolute; width: 261px; height: 54px; left: 515px; top: 798px; background-color: #858CE4; border: 2px solid #FFFFFF;
                            font-family: Mulish; font-style: normal; font-weight: bold; font-size: 28px;
                            text-align: left;
                            line-height: 35px;
                            letter-spacing: 0.1px;
                            color: #FFFFFF;" 
                   type = "submit" name = "preference" value = "Prefer not to say" /> <br/> <br/>
        </form>       
    </body>
</html>