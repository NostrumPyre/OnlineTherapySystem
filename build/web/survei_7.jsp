<%-- 
    Document   : survei_7
    Created on : Jan 26, 2022, 10:57:36 PM
    Author     : syafa
--%>
...
<html>
    ...
    <body style = "position: relative; height: 896px;">
        ...
        <center>
            <form name = "Survei_7_Form" method = "post" action = "survei_8.jsp" onsubmit = "return validateForm()">
                ...
                <div style = "position: absolute; width: 522px; height: 388px; left: 380px; top: 358px; background-color: rgba(133, 140, 228, 0.5);">
                    <h1 style = "color: white;">What is your preferred language?</h1>
                </div>
                
                <p style = "position: absolute; width: 300px; height: 15px; left: 498px; top: 480px;
                ...
                <input style = "position: absolute; width: 116px; height: 54px; left: 763px; top: 668px; background: #858CE4; border: 2px solid #FFFFFF;
                                font-family: Mulish; font-style: normal; font-weight: bold; font-size: 28px;
                                line-height: 35px;
                                letter-spacing: 0.1px;
                                color: #FFFFFF;" 
